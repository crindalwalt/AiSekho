       ...
       <main class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="mt-10 relative group cursor-pointer">
                <div class="aspect-video bg-gray-900 rounded-3xl border border-gray-800 flex items-center justify-center overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&q=80&w=1000" class="w-full h-full object-cover opacity-40 group-hover:scale-105 transition duration-500" alt="Course Preview">
                    <div class="absolute inset-0 flex items-center justify-center">
                        <div class="bg-lime-accent p-5 rounded-full shadow-lg shadow-lime-500/20">
                ...
                <p class="text-center text-sm text-gray-500 mt-4 italic">Click to watch the course introduction</p>
            </div>
            ...
            <div class="mt-16">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-[#1A1A1A] p-5 rounded-2xl border border-gray-800 flex justify-between items-center opacity-60">
                        <span class="font-medium text-gray-200">2. The Anatomy of a Perfect Prompt</span>
                    ...
                    <div class="bg-[#1A1A1A] p-5 rounded-2xl border border-gray-800 flex justify-between items-center opacity-60">
                        <span class="font-medium text-gray-200">3. Advanced Logic & Chain of Thought</span>
                        <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                    </div>
                </div>
            </div>
        ...
        <div class="space-y-8">
            ...
            <div class="bg-[#1A1A1A] p-6 rounded-[2rem] border border-gray-800">
                <h4 class="text-lg font-bold mb-4">Instructor</h4>
