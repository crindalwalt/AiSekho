                     ...
                     @foreach ($singleTeacher->courses as $item)
                         ...
                         <div class="bg-[#1A1A1A] border border-gray-800 p-6 rounded-[2rem] flex flex-col md:flex-row items-center gap-6 hover:border-lime-400/30 transition">
                            ...
                            <div class="flex gap-3 w-full md:w-auto">
                                <a href="{{ route('add-to-cart') }}" class="flex-1 md:flex-none px-6 py-3 bg-lime-accent text-black font-bold rounded-xl text-sm">Add to Cart</a>
                                <a href="{{ route('teacher-detail', $item->slug) }}" class="flex-1 md:flex-none px-6 py-3 border border-gray-700 rounded-xl text-sm hover:bg-gray-800 transition">View</a>
                            </div>
                        </div> 
                     @endforeach
                        @else
                            <p class="text-gray-400 text-sm mt-3">No courses available for this instructor at the moment. Please check back later.</p>
